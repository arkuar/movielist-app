      ...
      {reviews.map((r) => (
        <ReviewItemContainer key={r.id}>
          ...
          {username === r.user.username
            && (
              <button onClick={() => onDeleteClick(r.id)} className="items-center border-2 mt-5 md:mt-0 md:ml-auto flex justify-center bg-red-600 hover:bg-red-700 p-2 rounded-xl text-white font-medium uppercase transition-colors" type="button">
