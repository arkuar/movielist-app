      ...
      <Form className="mt-5 w-full">
        <div className="py-4">
          <label htmlFor="username">
            ...
            <div className="relative">
              <Field className="rounded-md pl-10 w-full placeholder-gray-400" id="username" type="text" name="username" placeholder="Username" />
        ...
        <div className="py-4">
          <label htmlFor="password">
            ...
            <div className="relative">
              <Field className="rounded-md pl-10 w-full placeholder-gray-400" id="password" name="password" type="password" placeholder="Password" />
              <div className="inline-flex justify-center items-center absolute left-0 h-full w-10 text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
